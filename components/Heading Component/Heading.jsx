...
const Heading = ({
  ...
  return (
    <div className={classNames(styles.MainContainer)}>
      <div>
        <span
          className={classNames(styles.spanHeading)}
          style={{
            ...(ContentUs_Css && {
              fontWeight: 400,
              width: "55vw",
      ...
      <div className={classNames(styles.subDiv)}>
        ...
        <div
          ...
          //     letterSpacing: "-0.1vw",
          //     paddingRight: "12vw",
          //     fontFamily: "TT Interphases Pro Trial Regular",
          //   }),
          //   ...(Portfolio_Css && {
          //     fontWeight: 400,
          //     width: "65vw",
