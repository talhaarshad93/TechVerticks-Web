  ...
  return (
    <div id="weBuild" className="container-fluid  pt-5 ,mt-4 d-flex ">
      <div className="left col-3   offset-1  mt-3 flex-column align-items-center justify-content-center">
        ...
        <Count name={name1} count={Count1} weBuildCSS={weBuildCSS}showPlus={showPlus} />
        <Count name={name2} count={Count2} weBuildCSS={weBuildCSS} showPlus={showPlus}/>
        <Count name={name3} count={Count3} weBuildCSS={weBuildCSS}showPlus={showPlus} />
      </div>
      <Description
        heading={heading}
        description={description}
        weBuildCSS={weBuildCSS}
      />
    </div>
  );
};
